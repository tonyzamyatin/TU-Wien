...
public class Aufgabe4 {
    ...
    private static boolean containsValue(int[] workArray, int value) {
        ...
        if (workArray[0] == value) {
            ...
            int[] half1 = Arrays.copyOfRange(workArray, 0, workArray.length / 2);
            int[] half2 = Arrays.copyOfRange(workArray, workArray.length / 2, workArray.length);
            return containsValue(half1, value) || containsValue(half2, value);
        }
